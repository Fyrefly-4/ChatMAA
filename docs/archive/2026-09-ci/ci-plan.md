> 归档日期：2026-09-18。来源：提交 `126808c` 的 `docs/engineering/ci-plan.md`；记录时期：2026-09-18 的 CI 简化实施。方案已实施并完成本轮验证，现归档保存决策和证据；日常运行与新增检查请查阅 [CI 使用与接入](../../engineering/ci-plan.md)。下方正文按来源冻结，历史验收和后续建议不构成新的执行要求。
