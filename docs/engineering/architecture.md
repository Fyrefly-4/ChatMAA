...
2026-09-18 CI 实施补充：已加入三个可复用离线检查、PR 按需调度和统一结果汇总；首轮 Windows runner 全套通过，后续观察尚未完成，未启用强制门禁。Python 3.13.15 已通过完整离线检查，未重跑实机。版本基线、运行证据及待验收场景见 [CI 方案](ci-plan.md)。
